...
2. Select your OIDC application and go to its **Authorization** tab.
...
5. Click **Finish**.
    ...
    ![Successfully authorized an MCP server in the app]({{base_path}}/assets/img/guides/authorization/mcp-authorization/authorized-mcp-server-to-mcp-client.png){: width="800" style="display: block; margin: 0; border: 0.3px solid lightgrey;"}
