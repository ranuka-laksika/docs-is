...
- [Authorize MCP servers]({{base_path}}/guides/authorization/mcp-server-authorization/) - Single-page applications can authorize MCP servers through the **Authorization** tab to enable AI agent interactions.