...
Optionally, you can configure backup codes to be used when SMS OTP is enabled but temporarily inaccessible (for example, when the user cannot receive the SMS).
