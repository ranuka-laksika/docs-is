...
Optionally, you can configure backup codes as a fallback option when SMS OTP is enabled but temporarily inaccessible (for example, when a user cannot receive the SMS).
