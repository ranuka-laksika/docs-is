...
Optionally, you can configure backup codes to be used as a fallback when SMS OTP is enabled but temporarily inaccessible (for example, when you cannot receive the SMS).
